...
public class HierarchyImporter : Editor
{
    ...
    public static void MakeThreeDIntractable()
    {
        ...
        if (selectedObject != null)
        {
            ...
            if (selectedObject.GetComponent<SplitMergeModel>() == null)
            {
                selectedObject.AddComponent<SplitMergeModel>();
            }

            // Add label manger
            if (selectedObject.GetComponent<LabelManager>() == null)
            {
                selectedObject.AddComponent<LabelManager>();
            }
